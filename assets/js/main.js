...
(function () {
  ...
  myLib.body.addEventListener("click", function (e) {
    ...
    if (popupItemClose || target.classList.contains("popup__body")) {
...
(function () {
  ...
  catalogNav.addEventListener("click", function (e) {
    ...
    for (var i = 0; i < catalogItems.length; i += 1) {
      ...
      // данная строка отвечает за то, когда мы нажимаем у нас выводится своя категория товара
      var categories = current.getAttribute("data-category");
